...
public class PokemonData
{
    ...
    public PokemonData(string id = "0", string name = "", string[] types = null, Texture2D f_sprite = null, Texture2D b_sprite = null, string height = "", string weight = "", List<PokemonMove> moves = null, string info = null)
    {
        this.id = id;
        this.name = name;
